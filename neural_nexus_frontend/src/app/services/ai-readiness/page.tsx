        ...
        <div className="flex flex-col">
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-gray-600 mb-8">
                            Navigate your AI journey with confidence. From
                            readiness assessment to implementation, we ensure
                            your organization is prepared for successful AI
                            adoption.
                        </p>
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                        Our assessment framework evaluates your organization
                        across six critical dimensions to ensure successful AI
                        implementation.
                    </p>
              ...
              `}
                            >
                                ...
                                <Button
                                    className="w-full"
                                    variant={
                                        program.featured ? "default" : "outline"
                                    }
                                    asChild
                                >
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
                        Use our calculator to estimate the potential return on
                        investment for your AI initiatives.
                    </p>
                    <AIROICalculator />
                </div>
            </section>
            ...
            <section className="py-16 bg-success-600">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-success-100 mb-8 max-w-2xl mx-auto">
                        Get a comprehensive assessment of your organization's AI
                        readiness and a clear roadmap for successful
                        implementation.
                    </p>
                    <Button
                        size="lg"
...
const roadmapSteps = [
    ...
    },
    {
        ...
        description:
            "Execute AI initiatives with careful monitoring and support.",
        deliverables: [
            "Pilot projects",
            "Scale planning",
            "Success metrics",
...
const programs = [
    ...
    },
    {
        ...
        duration: "8 weeks",
        description:
            "End-to-end support from assessment through implementation",
        features: [
