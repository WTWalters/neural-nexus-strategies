// src/app/services/fractional-cdo/page.tsx
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-gray-600 mb-8">
                            Enterprise-grade data leadership without the cost of
                            a full-time executive. Get strategic guidance,
                            implementation expertise, and ongoing support.
                        </p>
            ...
            <section className="py-16 bg-primary-600">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
                        Schedule a discovery call to discuss how our Fractional
                        CDO services can help your organization leverage data
                    ...
                    <Button
                        ...
                        asChild
                    >
                        <Link href="/book-call">Book Your Discovery Call</Link>
                    </Button>
                </div>
            </section>
        </div>
...
// Add these components/constants at the bottom of the file
...
const services = [
    ...
    },
    {
        ...
        description:
            "Define and track KPIs to measure data initiative success.",
    },
];
...
const pricingPlans = [
    {
        ...
        price: "5,000",
        description:
            "Perfect for growing companies starting their data journey",
        features: [
    ...
    },
    {
        ...
        price: "20,000",
        description:
            "For organizations where data is a critical strategic asset",
        features: [
