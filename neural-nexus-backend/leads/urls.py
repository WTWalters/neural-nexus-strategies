...
from .views import ROICalculatorViewSet, ContactFormView, NewsletterSubscriptionView,  LeadScoringView  # Add this import
...
urlpatterns = [
    ...
    path('lead-scoring/<int:contact_id>/', LeadScoringView.as_view(), name='lead_scoring'),
]
